...
// //   const conversationId = getConversationId(listingId, user._id, hostId);
...
// // Initialize socket outside component to persist across renders
// const socket = io(import.meta.env.VITE_API_URL, {
//   transports: ["websocket"],
//   withCredentials: true,
//   autoConnect: false, // prevent auto-connect before auth
// });
...
//   const conversationId = user ? getConversationId(listingId, user._id, hostId) : null;
...
//   // Connect socket after user and token are available
//   useEffect(() => {
//     if (!user || !conversationId) return;
